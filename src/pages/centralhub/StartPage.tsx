...
function SortableWidget({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`tactical-card p-0 flex flex-col relative group overflow-hidden ${getColSpan()} shadow-[0_20px_50px_rgba(0,0,0,0.3)] ring-1 ring-white/10 hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)] transition-shadow duration-500`}
    >
